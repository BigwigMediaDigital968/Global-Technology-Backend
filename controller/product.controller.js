...
exports.createProduct = async (req, res) => {
  try {
    ...
    /* -------------------------------
       Convert extraDetails → Map
    -------------------------------- */
    const extraDetailsMap = new Map(Object.entries(extraDetails));
...
exports.updateProduct = async (req, res) => {
  try {
    const { slug, collectionName, sizes, extraDetails } = req.body;
    ...
    -------------------------------- */
    if (extraDetails) {
      product.extraDetails = new Map(Object.entries(extraDetails));
    }
